...
public class AtlasMap extends ActionBarActivity implements OnMapReadyCallback, GoogleMap.OnMapLoadedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            //I set hybrid as the default map type. This can be changed.
        ...
        //Threads necessary for checking the data that is being downloaded in the background.
        t1 = new Thread(r1);
        t1.run();
        t2 = new Thread(r2);
        t2.run();
    ...
    public void onMapReady(GoogleMap map)
    {
        ...
        //Just shows where you are. Lets the user know that the GPS is working.
        mMap = map;
        LatLng currPos = new LatLng(currentLat, currentLong);
        Log.d("LatLong", Double.toString(currentLat) + " , " + Double.toString(currentLong));
        mMap.setMyLocationEnabled(true);
    ...
    {
        // This just converts the user's choice of radius to a string. For aesthetic purposes.
        Double kmVal = 0.0;
        switch (kmString)
        {
            case "10 KM":
    ...
    //Set the retrieved data to the JSONArray.
    ...
    public void SortData(double kmString, String currSpecies, String dateObserved, String useUser) throws JSONException
    {
        ...
        Log.d("SizeAfterSort", Integer.toString(areaSpeciesList.size()));
            ...
            areaAdapter.notifyDataSetChanged();
            speciesAmt.setText(Integer.toString(dataRetrieved.length()) + " record(2) found.");
